...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new dev.badver.flutter_app_icon_badge.FlutterAppIconBadgePlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin flutter_app_icon_badge, dev.badver.flutter_app_icon_badge.FlutterAppIconBadgePlugin", e);
    }
    try {
